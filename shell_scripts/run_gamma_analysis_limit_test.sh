...
ds=$i
echo $ds
odir="/nfs/gerda2/users/rizalinko/gamma-fitter/run0053-run0092/gamma_analysis_test1"
...
/nfs/gerda2/users/rizalinko/gamma-analysis/peaksearch -g ${line} -e ${en} -k ${kl} -d ${ds} -b ${bing} -r ${rescrv} -o ${odir} -j ${batprec} -w ${woi} -z
