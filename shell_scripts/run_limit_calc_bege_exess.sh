...
for en in 649 948 949 950 1059 1076 1204 1205 1409 1653 1847 2099 3636 4321 4322 5220 5262 5263 5264 5265 5266
do
line="limit_${en}"
...
ogamma="${odir}/gamma.log"


echo "gammacounts -g ${line} -e ${en} -k ${kl} -d ${ds} -b ${bing} -r ${rescrv} -o ${odir} -j ${batprec} -w ${woi}> log_${log_file}.txt"
done
