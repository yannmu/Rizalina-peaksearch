   ...
   public:
      ...
      GammaFitFunction( const char* name,
         ...
         for(int i=0; i<nGaus; i++)
            protoFct->AddProtoFct(new GammaProtoNormGaus(
             Form("mean%d",i),Form("fwhm%d",i),Form("intnsty%d",i)));
        protoFct->AddProtoFct(new GammaProtoLinearBackground("bkgrnd","slpe"));
